...
const Projects = () => {
  return (
    <div name='projects' className='w-full min-h-screen bg-[#0c1f3d] text-gray-300'>
      <div className='max-w-screen-sm mx-auto p-4'>
        <div>
          <p className='text-2xl md:text-4xl font-bold inline border-b-4 border-purple-600 text-gray-300'>
            Projects
          </p>
        </div>
        <div className='max-w-xl mx-auto'>
          <Carousel infiniteLoop autoPlay interval={5000} showThumbs={false}>
            <div className='shadow-md shadow-[#040c16] p-4 mb-4'>
              <img className='w-full md:w-20 mx-auto' src={FubarGaming} alt='project 1' />
            ...
            <div className='shadow-md shadow-[#040c16] p-4 mb-4'>
              <img className='w-full md:w-20 mx-auto' src={Zelda} alt='project 2' />
              <h3 className='my-4'>Zelda Remake</h3>
              <p>Zelda inspired remake using Kaboomjs game library.</p>
            </div>
            <div className='shadow-md shadow-[#040c16] p-4 mb-4'>
              <img className='w-full md:w-20 mx-auto' src={QRCode} alt='project 3' />
              <h3 className='my-4'>QR code Generator</h3>
              <p>Simple QR code generator.</p>
            </div>
            <div className='shadow-md shadow-[#040c16] p-4 mb-4'>
              <img className='w-full md:w-20 mx-auto' src={OUAT} alt='project 4' />
